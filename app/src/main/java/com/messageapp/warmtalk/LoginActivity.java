...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(LoginActivity.this,"Пожалуйста, введите адрес электронной почты...",Toast.LENGTH_SHORT).show();
                }
    ...
    private void sendUsertoForgotPassword() {
        Intent newuserIntent=new Intent(LoginActivity.this, ForgotPassword.class);
