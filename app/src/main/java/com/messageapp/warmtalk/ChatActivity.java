...
public class ChatActivity extends AppCompatActivity {
        ...
        sendFileButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CharSequence options[]=new CharSequence[]{
                        "Картинки","PDF файлы","Ms Word файлы"
                };
                ...
                builder.setItems(options, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(which==0)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent,"Выберите картинку"),555);
                        ...
                        }else if(which==1)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent,"Выберите PDF файл"),555);
                        ...
                        }else if(which==2)
                        {
                            ...
                            startActivityForResult(intent.createChooser(intent,"Выберите Ms Word File"),555);
                        }
                    }
                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        {
            loadingBar.setTitle("ОТПРАВКА ФАЙЛА");
            loadingBar.setMessage("Пожалуйста подождите Ваш файл отправляется...");
        ...
        RootRef.child("Users").child(messageRecieverId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(dataSnapshot.child("userState").hasChild("state"))
                {
                    ...
                    {
                        userlastseen.setText("Последний раз был в сети: "+"\n"+date+" "+time);
                    }
                }
                else
                {
                    userlastseen.setText("Не в сети");
                }
            }
    ...
    private void SendMessage() {
        ...
        {
            Toast.makeText(this,"Пожалуйста сначала введите сообщение...",Toast.LENGTH_SHORT).show();
        }
        else
        {
